...
Route::group(['prefix' => 'painel', 'namespace' => 'Painel'], function()
{
  ...
  Route::post('/sistema/salvar-popup', 'ConfiguracaoController@salvar_popup');
  ...
  Route::get('/parceiro/editar/{id}', 'ParceiroController@editar');
  Route::post('/parceiro/salvar', 'ParceiroController@salvar'); 
  Route::get('/parceiro/excluir/{id}', 'ParceiroController@excluir');
...
Route::group(['namespace' => 'Site'], function()
{
  ...
  Route::post('/contato', 'ContatoController@index_enviar');
  Route::get('/associar-se', 'ContatoController@associar');
  Route::get('/associado', 'ContatoController@associado');
  Route::post('/associar-se', 'ContatoController@associar_enviar');
