...
<head>
  ...
  <link rel="stylesheet" href="<?php print $url_base; ?>/dist/css/froala/froala_editor.css">
  <link rel="stylesheet" href="<?php print $url_base; ?>/dist/css/froala/froala_style.css">
  <link rel="stylesheet" href="<?php print $url_base; ?>/dist/css/froala/plugins/code_view.css">
  <link rel="stylesheet" href="<?php print $url_base; ?>/dist/css/froala/plugins/image_manager.css">
  <link rel="stylesheet" href="<?php print $url_base; ?>/dist/css/froala/plugins/image.css">
  <link rel="stylesheet" href="<?php print $url_base; ?>/dist/css/froala/plugins/table.css">
  <link rel="stylesheet" href="<?php print $url_base; ?>/dist/css/froala/plugins/video.css">
...
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/froala_editor.min.js"></script>
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/plugins/align.min.js"></script>
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/plugins/code_beautifier.min.js"></script>
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/plugins/code_view.min.js"></script>
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/plugins/draggable.min.js"></script>
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/plugins/image.min.js"></script>
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/plugins/image_manager.min.js"></script>
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/plugins/link.min.js"></script>
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/plugins/lists.min.js"></script>
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/plugins/paragraph_format.min.js"></script>
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/plugins/paragraph_style.min.js"></script>
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/plugins/table.min.js"></script>
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/plugins/video.min.js"></script>
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/plugins/url.min.js"></script>
<script type="text/javascript" src="<?php print $url_base; ?>/dist/js/froala/plugins/entities.min.js"></script>
