...
class PaginaController extends PainelController {
    ...
    public function index(){
        ...
        $paginas0 = Pagina::where(['parent_id' => 0])->orderBy('ordem', 'ASC')->get();
        ...
        foreach ($paginas0 as $item) {
            ...
            $paginas1 = Pagina::where(['parent_id' => $id0])->orderBy('ordem', 'ASC')->get();
            ...
            foreach ($paginas1 as $item1) {
                ...
                $paginas2 = Pagina::where(['parent_id' => $id1])->orderBy('ordem', 'ASC')->get();
