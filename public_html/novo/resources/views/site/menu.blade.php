        ...
        <div class="top-bar">
            <div class="container">
                ...
                <div class="quick-link">
                    <!--<a href="<?php print $url_base; ?>/associar-se"><i class="fa fa-user"></i> <b>Associar-se</b></a>|-->
                    <a href="#">2ª Via Boleto</a>|
                    <a href="<?php print $url_base; ?>/faq">FAQ</a>|
					<a href="<?php print $url_base; ?>/REGIMENTO-INTERNO-2022.pdf" target="blank"><b>Regimento Interno</b></a>
                </div>
            </div>
        </div>
        <div class="header-main">
            <div class="container">
                ...
                <div class="contact-widget" style="margin-top: 12px;">
                    ...
                    <a href="<?php print $url_base; ?>/associado"><button class="au-btn au-btn-sm au-btn-orange hidden-md-phone">Área do Associado</button></a>
                </div>
            </div>
        </div>
